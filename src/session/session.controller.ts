...
export class SessionController {
  ...
  @AuthGuard()
  @Get('current/@me')
  async getCurrentSession(@User() user: UserPayload): Promise<GetSessionRdo> {
  ...
  @AuthGuard()
  @Get('all/@me')
  async getUserSessions(@User() user: UserPayload): Promise<GetSessionRdo[]> {
  ...
  @AuthGuard()
  @Delete('logoutAll/@me')
  async removeAllSessions(@User() user: UserPayload) {
